          ...
          {images.map((item, index) => (
            ...
            >
              <img
                ...
                alt=""
              />
              <p className="absolute bottom-0 right-0 text-xs bg-black/50 backdrop-blur text-white px-4 py-1 rounded-t-xl opacity-0 group-hover:opacity-100 transition duration-300">
